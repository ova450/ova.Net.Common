...
using ova.Common.Logging.Abstract;
using System;
    ...
    public class FileLoggerProvider : LoggerProvider
    {
        ...
        void WriteLine(string Text)
        {
            ...
            if (Counter % 100 == 0)
            {
                ...
                if (FI.Length > (1024 * 1024 * Settings.MaxFileSizeInMB)) { BeginFile(); }
            }
        ...
        {
            if (string.IsNullOrWhiteSpace(Text)) return "".PadRight(MaxLength);
        ...
        void WriteLogLine()
        {
            ...
            if (InfoQueue.TryDequeue(out Info))
            {
                ...
                if (Info.Scopes != null && Info.Scopes.Count > 0)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(SI.Text)) { S = SI.Text; }
                }
                ...
                if (!string.IsNullOrWhiteSpace(Text)) { SB.Append(Text.Replace("\r\n", " ").Replace("\r", " ").Replace("\n", " ")); }
