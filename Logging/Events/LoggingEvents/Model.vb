...
Namespace Model
    ...
    Public Class EventObject : Inherits EventElementAbstract
    ...
    Public Class EventProcess : Inherits EventElementAbstract
        Public Overrides Function EventId() As EventId
            Return New EventId(Id * 100, Name)
        End Function
    End Class

    Public Class EventStage : Inherits EventElementAbstract : End Class

    '<EntityLevelInitial(1)>
    ...
    '    Public Overrides Function EventId() As EventId
    '        Return New EventId(EventObject.Id + EventProcessId + EventStageId, Name)
    '    End Function
